...
Describe "Deploys Minimal API" {
    ...
    It "runs without errors with no init" {
    ...
    It "runs without errors with no hook" {
    ...
    It "runs without errors with no hook or init" {
    ...
    It "has the main container crash" {
    ...
    It "has the main container has bad image tag" {
    ...
    It "has the main container has bad secret name" {
    ...
    It "has the main container that times out" {
    ...
    It "gets a temporary startup timeout" {
    ...
    It "has the prehook job's container that times out" {
